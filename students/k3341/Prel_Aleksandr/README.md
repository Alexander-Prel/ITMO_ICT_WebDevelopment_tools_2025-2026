...
- [Лабораторная работа 3: Docker, HTTP-парсер, Celery и Redis](Lr3/README.md).
...
Контейнеры и фоновый импорт находятся в `Lr3/`; сборка использует код
соседних `Lr1/` и `Lr2/`, а данные хранятся в отдельной контейнерной БД.
